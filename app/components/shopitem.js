...
module.exports = React.createClass({
  ...
  handlerProduct: function(){
    window.to('/productmanage?id=' + this.props.data._id);
  },
  handlerOrder: function(){
    window.to('/orderaudit?id=' + this.props.data._id);
  },
  render:function(){
    return (
      <div style={swiper_div}>
        <div style={content}>
          ...
          <div style={contentstyle}>
            ...
            <div style={selfoperation}>{"类型：" + this.props.data.type}</div>
          </div>
          <div style={contentstyleOrder}>
            <div style={shopname}>{this.props.data.shoper + "  " + this.props.data.tel}</div>
          ...
          <div style={contentstyleButtons}>
            ...
            <div style={this.props.data.status == "1" ? rightRed : rightHide} onClick={this.handlerDisabled}>
              禁用
            </div>
            <div style={this.props.data.status == "1" ? rightGreen : rightHide} onClick={this.handlerProduct}>
              产品管理
            </div>
            <div style={this.props.data.status == "1" ? rightPupel : rightHide} onClick={this.handlerOrder}>
              订单管理
            </div>
            <div style={this.props.data.status == "0" ? right : rightHide} onClick={this.handlerEnabled}>
              启用
            </div>
